...
export const Switch: React.FC<SwitchProps> = ({ size = 'sm', onChangeValue, enabled }) => {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className={classNames(
          enabled ? (size === 'base' ? 'translate-x-6' : 'translate-x-5') : 'translate-x-0 border border-gray-600',
