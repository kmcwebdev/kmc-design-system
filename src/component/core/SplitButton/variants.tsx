...
export const variantToClassName: Record<ButtonVariant, ClassInterface> = {
  ...
  'outlined-primary': {
    parent:
      'text-interactive-primary-neutral hover:text-interactive-primary-hovered active:text-interactive-primary-pressed',
    child:
      'border border-interactive-primary-neutral group-hover:bg-surface-primary-hovered box-border first-of-type:rounded-l last-of-type:rounded-r',
  },
  ...
  'outlined-success': {
    parent: 'text-white',
    child:
      'border border-interactive-success-neutral text-interactive-success-neutral group-hover:text-interactive-success-hovered group-active:text-interactive-success-pressed group-hover:bg-surface-success-hovered',
  },

  'outlined-warning': {
    parent: 'text-white',
    child:
      'border border-interactive-warning-neutral text-interactive-warning-neutral group-hover:text-interactive-warning-hovered group-active:text-interactive-warning-pressed group-hover:bg-surface-warning-hovered',
  },

  'outlined-danger': {
    parent: 'text-white',
    child:
      'border border-interactive-danger-neutral text-interactive-danger-neutral group-hover:text-interactive-danger-hovered group-active:text-interactive-danger-pressed group-hover:bg-surface-danger-hovered',
  },

  'outlined-info': {
    parent: 'text-white',
    child:
      'border border-interactive-info-neutral text-interactive-info-neutral group-hover:text-interactive-info-hovered group-active:text-interactive-info-pressed group-hover:bg-surface-info-hovered',
  },
};
