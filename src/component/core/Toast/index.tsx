...
export const Toast: React.FC<ToastProps> = ({ variant = 'success', message, t }) => {
      ...
      <div aria-live="assertive">
        <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
          ...
          >
            ...
            >
              <div className={classNames('flex divide-x-2 px-6 py-5 gap-2 md:gap-4', propertyToUse.className)}>
